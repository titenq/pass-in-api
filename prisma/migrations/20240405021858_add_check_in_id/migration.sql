/*
  ...
  - Added the required column `check_in_id` to the `attendees` table without a default value. This is not possible if the table is not empty.
  - Added the required column `check_in_id` to the `check_ins` table without a default value. This is not possible if the table is not empty.
